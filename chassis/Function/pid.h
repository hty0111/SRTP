...
#define CHASSIS_SPEED_PID_MAX_OUT 10000.f
#define CHASSIS_SPEED_PID_MAX_IOUT 5000.0f

// 整车角度环
#define CHASSIS_ANGLE_PID_KP 2.0f
#define CHASSIS_ANGLE_PID_KI 0.0f
#define CHASSIS_ANGLE_PID_KD 0.0f
#define CHASSIS_ANGLE_PID_MAX_OUT 10000.f
#define CHASSIS_ANGLE_PID_MAX_IOUT 5000.0f
